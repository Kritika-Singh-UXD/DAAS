  ...
  return (
    <div className="p-6 bg-white">
      ...
      <div className="flex gap-2 mb-3">
        <div className="flex-1 bg-primary-50 border border-primary-200 rounded-lg p-2 min-w-0">
          <div className="text-lg font-bold text-primary-900 truncate">{insights.evidenceBasedPercentage}%</div>
          <div className="text-xs text-primary-700 truncate">Evidence-Based</div>
        </div>
        
        <div className="flex-1 bg-primary-50 border border-primary-200 rounded-lg p-2 min-w-0">
          <div className="text-lg font-bold text-primary-900 truncate">{insights.averageCitationsPerAnswer}</div>
          <div className="text-xs text-primary-700 truncate">Avg Citations</div>
        </div>
      </div>
      ...
      <div className="mb-3">
        <div className="space-y-1">
          <div className="flex items-center justify-between p-2 bg-primary-50 border border-primary-200 rounded">
            <div className="flex-1 min-w-0 pr-2">
              <div className="text-xs font-medium text-primary-900 truncate">With Citations</div>
              <div className="text-xs text-primary-600 truncate">{insights.totalCitations} total</div>
            </div>
            <div className="text-sm font-bold text-primary-900">{insights.answersWithCitations}</div>
          </div>
